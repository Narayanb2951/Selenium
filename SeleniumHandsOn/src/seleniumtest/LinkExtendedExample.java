...
public class LinkExtendedExample {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		WebElement sLink1 = driver.findElement(By.xpath("//*[contains(text(),'Take me to dashboard')]/following-sibling::div/div/a"));	
		sLink1.click();
		...
		//Find my destination
		WebElement sLink2 = driver.findElement(By.xpath("//*[contains(text(),'Find my destination')]/following-sibling::div/div/a"));	
		String sLinkWithOutClick = sLink2.getAttribute("href");
		System.out.println("Find my destination is  " + sLinkWithOutClick );		
		Thread.sleep(3000);

		//Am I broken link?
		WebElement sLink3 = driver.findElement(By.xpath("//*[contains(text(),'Am I broken link?')]/following-sibling::div/div/a"));	
		sLink3.click();
